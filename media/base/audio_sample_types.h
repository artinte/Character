//
// Created by wangrl2016 on 2023/2/24.
//

#ifndef ONESTUDIO_AUDIO_SAMPLE_TYPES_H
#define ONESTUDIO_AUDIO_SAMPLE_TYPES_H
...
// "SampleTypeTraits", which requires that the following public are provided:
...
namespace media {
    ...
    private:
        ...
        struct ScalingFactors {
            ...
            // representation of the max value is only off by 1, i.e. it quantize to
...
#endif //ONESTUDIO_AUDIO_SAMPLE_TYPES_H
